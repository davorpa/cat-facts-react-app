...
Recupera un hecho aleatorio acerca de los gatos junto a una imagen con ciertas palabras de dicho hecho aleatorio.
...
```shell
npm create vite@latest cat-facts-react-app --template react-swc
```
